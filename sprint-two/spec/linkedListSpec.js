describe('linkedList', function() {
  ...
  it('should have methods named "addToHead","removeTail", "addToTail", "removeHead", and "contains"', function() {
  ...
  it('should designate a new head when addToHead is used', function(){
